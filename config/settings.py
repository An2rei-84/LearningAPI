...
DATABASES = {
    "default": {
        ...
        ),  # Используем ваше имя БД по умолчанию
        "USER": os.getenv(
            "DB_USER", "postgres"
        ),  # Используем вашего пользователя по умолчанию
        "PASSWORD": os.getenv(
            "DB_PASSWORD", "12345"
...
CELERY_BEAT_SCHEDULE = {
    # Блокировка неактивных пользователей каждый день в 6:00 UTC
